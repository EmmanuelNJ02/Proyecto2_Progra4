...
import EmptyState from '../../../../../../Proyecto2_BolsaEmpleo_Emmanuel_Dorian_Corregido/Proyecto2_BolsaEmpleo_Emmanuel_Dorian_FINAL_ESTABLE_DISENO_CORREGIDO/frontend/src/shared/components/EmptyState.jsx';
...
export default function SearchJobs() {
  ...
  return (
    <section className="search-page">
      <FeatureFilter features={features} selected={selected} onToggle={toggle} onSearch={buscar} onClear={limpiar} />
      <section className="results-panel">
        ...
        {loading ? (
          ...
          <div className="results-grid">{results.map(p => <JobCard key={p.id} puesto={p} />)}</div>
        ) : (
          <EmptyState title="Sin resultados" message="No hay puestos públicos que coincidan con las características seleccionadas." />
        )}
      </section>
    </section>
  );
