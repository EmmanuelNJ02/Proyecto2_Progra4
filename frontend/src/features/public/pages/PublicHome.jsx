...
export default function PublicHome() {
  ...
  useEffect(() => {
    publicService.puestosRecientes()
        .then(setPuestos)
      ...
      <>
        <section className="hero">
          <div className="hero-card">
            ...
            <p>
              Publicá puestos, registrá habilidades, subí tu CV en PDF y consultá coincidencias
              entre lo solicitado por empresas y lo ofrecido por candidatos.
            </p>
        ...
        {loading ? (
            ...
            <section className="grid">
              {puestos.map(p => <JobCard key={p.id} puesto={p} />)}
            </section>
        )}
      </>
  );
