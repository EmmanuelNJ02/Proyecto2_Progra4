import { childrenOf, parentFeatures } from '../../../../../../Proyecto2_BolsaEmpleo_Emmanuel_Dorian_Corregido/Proyecto2_BolsaEmpleo_Emmanuel_Dorian_FINAL_ESTABLE_DISENO_CORREGIDO/frontend/src/shared/utils/formatters.js';
  ...
  return (
    <aside className="panel filter-panel">
      <div className="filter-header">
        ...
        <p className="muted">Selecciona una o varias características para filtrar únicamente puestos públicos activos.</p>
      </div>
